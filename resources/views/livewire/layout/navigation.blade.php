    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto py-2 px-2 space-y-0.5 overflow-x-hidden">
            ...
            $adminItems = [
                ...
                ['route' => 'admin.custom-fields.index', 'label' => __('Custom Fields'), 'match' => 'admin.custom-fields.*',
                 'icon' => 'M4 7a2 2 0 012-2h3l2 2h7a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2V7zm4 5h8m-8 4h5'],
                ['route' => 'admin.activity-log.index', 'label' => __('Activity Log'), 'match' => 'admin.activity-log.*',
