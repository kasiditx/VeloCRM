<div class="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <a href="{{ route('public.invoice.pdf', ['token' => $invoice->public_token, 'locale' => app()->getLocale()]) }}" target="_blank" class="rounded-xl bg-primary-600 px-4 py-2 text-sm font-bold text-white transition hover:bg-primary-700">{{ __('Download PDF') }}</a>
    </div>
