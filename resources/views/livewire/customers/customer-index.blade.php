                                ...
                                <td class="px-6 py-4 text-right text-sm font-medium">
                                    <div class="flex justify-end gap-2">
                                        @if ($showTrashed)
                                            ...
                                            <button wire:click="forceDelete({{ $customer->id }})" wire:loading.attr="disabled" wire:target="forceDelete({{ $customer->id }})" wire:confirm="{{ __('Permanently delete this customer?') }}" class="module-icon-button hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/30" title="{{ __('Delete Permanently') }}" aria-label="{{ __('Delete Permanently') }}">
                                        ...
                                        @else
                                            ...
                                            <button wire:click="delete({{ $customer->id }})" wire:loading.attr="disabled" wire:target="delete({{ $customer->id }})" wire:confirm="{{ __('Move this customer to trash?') }}" class="module-icon-button hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/30" title="{{ __('Delete') }}" aria-label="{{ __('Delete') }}">
                                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                                            </button>
                                        @endif
                                    </div>
